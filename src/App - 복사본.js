...
function App() {
    ...
    useGSAP(() => {
        ...
        // document.querySelector('.dlvr02_tab').classList.remove('on');
        // document.querySelector('.dlvr02_tab0').classList.add('on');

        // gsap.set('.dlvr02_tab .tab_bg', {scale: 0});
        // gsap.set('.dlvr02_tab .tab_img', {rotate: 0});

        let tl2 = gsap.timeline({paused: true});

        tl2.add([
            gsap.fromTo('.dlvr02_tab.on .tab_bg', {scale: 0}, {scale: 1, ease: 'back.out'}),
            gsap.fromTo('.dlvr02_tab.on .tab_img', {rotate: 0}, {rotate: 15, ease: 'back.out(4)'}),
        ])
